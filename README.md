...
- В настройках подключить приложение `rest_framework.authtoken` и сконфигурировать `DEFAULT_AUTHENTICATION_CLASSES`. Для того, чтобы завести токен для пользователя, необходимо проделать следующие шаги:
...
Вам необходимо будет создать базу в postgres в соответствии с настройками в файле <a href="https://github.com/RavenRVS/DJ_HW7/blob/master/api_with_restrictions/settings.py">settings.py</a> или задать свои настройки и прогнать миграции:
